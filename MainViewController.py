...
class MainViewController:
    ...
    #         filtered_second_signal = butter_bandpass_filter(second_signal_data, 847500 - 847500 / 2,
    #                                                         847500 + 847500 / 1,
    ...
    #     filtered_second_signal = butter_bandpass_filter(SECOND_ORIGINAL_SIGNAL, 847500 - 847500 / 2,
    #                                                     847500 + 847500 / 2,
    ...
    #         filtered_first_signal = butter_bandpass_filter(original_first_signal, 847500 - 847500 / 2,
    #                                                        847500 + 847500 / 1,
    #                                                        FIRST_SIGNAL_SAMPLE_RATE, 1)
    #         filtered_second_signal = butter_bandpass_filter(original_second_signal, 847500 - 847500 / 2,
    #                                                         847500 + 847500 / 1,
    #                                                         SECOND_SIGNAL_SAMPLE_RATE, 1)
    #
    #         __ratio = 0
    ...
    #             if __find_min_value > (
    #                     filtered_first_signal[__first_sink:__first_sink + t_ATQA_one] - filtered_second_signal[
    ...
    #
    #     plt.figure(2)
    #     ns1, ns2 = get_envelop_signal(filtered_first_signal, filtered_second_signal, sync_first_sample,
    #                                   sync_second_sample)
    #     show_plot(ns1, ns2)
    #
